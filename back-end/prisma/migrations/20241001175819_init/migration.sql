...
-- AddForeignKey
ALTER TABLE "TweetLike" ADD CONSTRAINT "TweetLike_tweeId_fkey" FOREIGN KEY ("tweeId") REFERENCES "Tweet"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
